...
public:
  SimuResults() = default;
  SimuResults(std::vector<double> cost_iter, std::vector<Eigen::Vector2d> velocity,
              std::vector<Eigen::Vector2d> accelaration, std::map<int, std::vector<double>> dis_robot,
