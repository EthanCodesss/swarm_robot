...
bool AStar::ConvertToIndexAndAdjustStartEndPoints(Vector2d start_pt,
                                                  Vector2d end_pt,
                                                  Vector2i &start_idx,
                                                  Vector2i &end_idx) {
...
bool AStar::AstarSearch(const double step_size, Vector2d start_pt,
                        Vector2d end_pt, bool use_esdf_check) {
...
vector<Vector2d> AStar::astarSearchAndGetSimplePath(const double step_size,
                                                    Vector2d start_pt,
                                                    Vector2d end_pt) {
