...
PlanningVisualization::PlanningVisualization(ros::NodeHandle &nh) {
  ...
  init_list_debug_pub =
      nh.advertise<visualization_msgs::Marker>("init_debug_list", 2);

  intermediate_pt0_pub =
      nh.advertise<visualization_msgs::Marker>("pt0_dur_opt", 10);
  intermediate_grad0_pub =
      nh.advertise<visualization_msgs::MarkerArray>("grad0_dur_opt", 10);
  intermediate_pt1_pub =
      nh.advertise<visualization_msgs::Marker>("pt1_dur_opt", 10);
...
void PlanningVisualization::drone_0_odomeCallback(
...
void PlanningVisualization::drone_1_odomeCallback(
    const nav_msgs::OdometryConstPtr &msg) {
...
void PlanningVisualization::drone_2_odomeCallback(
    const nav_msgs::OdometryConstPtr &msg) {
...
void PlanningVisualization::drone_3_odomeCallback(
    const nav_msgs::OdometryConstPtr &msg) {
...
void PlanningVisualization::drone_4_odomeCallback(
    const nav_msgs::OdometryConstPtr &msg) {
...
void PlanningVisualization::drone_5_odomeCallback(
    const nav_msgs::OdometryConstPtr &msg) {
...
void PlanningVisualization::drone_6_odomeCallback(
    const nav_msgs::OdometryConstPtr &msg) {
  if (formation_size_ <= 5)
    return;
...
void PlanningVisualization::drone_7_odomeCallback(
    const nav_msgs::OdometryConstPtr &msg) {
...
void PlanningVisualization::drone_8_odomeCallback(
    const nav_msgs::OdometryConstPtr &msg) {
...
void PlanningVisualization::drone_9_odomeCallback(
    const nav_msgs::OdometryConstPtr &msg) {
...
void PlanningVisualization::drone_10_odomeCallback(
    const nav_msgs::OdometryConstPtr &msg) {
...
void PlanningVisualization::drone_11_odomeCallback(
    const nav_msgs::OdometryConstPtr &msg) {
...
void PlanningVisualization::displayMarkerList(
    ros::Publisher &pub, const vector<Eigen::Vector2d> &list, double scale,
...
void PlanningVisualization::generatePathDisplayArray(
    visualization_msgs::MarkerArray &array, const vector<Eigen::Vector2d> &list,
...
void PlanningVisualization::displayGoalPoint(Eigen::Vector2d goal_point,
...
void PlanningVisualization::displayGlobalPathList(
    vector<Eigen::Vector2d> init_pts, const double scale, int id) {
...
void PlanningVisualization::displayMultiInitPathList(
    vector<vector<Eigen::Vector2d>> init_trajs, const double scale) {
...
void PlanningVisualization::displayInitPathListDebug(
    vector<Eigen::Vector2d> init_pts, const double scale, int id) {
...
void PlanningVisualization::displayAStarList(
    std::vector<std::vector<Eigen::Vector2d>> a_star_paths,
